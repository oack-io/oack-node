...
export class StatusPages {
	...
	async create(accountId: string, params: CreateStatusPageParams): Promise<StatusPage> {
		return JSON.parse(
			await this.client.request("POST", `/api/v1/accounts/${accountId}/status-pages`, { json: params }),
		) as StatusPage;
	}
	...
	async get(accountId: string, pageId: string): Promise<StatusPage> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}`),
		) as StatusPage;
	}

	async update(accountId: string, pageId: string, params: UpdateStatusPageParams): Promise<StatusPage> {
		return JSON.parse(
			await this.client.request("PUT", `/api/v1/accounts/${accountId}/status-pages/${pageId}`, { json: params }),
		) as StatusPage;
	}
	...
	async createComponentGroup(
		...
		return JSON.parse(
			await this.client.request("POST", `/api/v1/accounts/${accountId}/status-pages/${pageId}/component-groups`, {
				json: params,
			}),
		) as ComponentGroup;
	}
	...
	async listComponentGroups(accountId: string, pageId: string): Promise<ComponentGroup[]> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/component-groups`),
		) as ComponentGroup[];
	}
	...
	async updateComponentGroup(
		...
		pageId: string,
		groupId: string,
		params: UpdateComponentGroupParams,
	): Promise<ComponentGroup> {
		return JSON.parse(
	...
	async createComponent(accountId: string, pageId: string, params: CreateComponentParams): Promise<Component> {
		return JSON.parse(
			await this.client.request("POST", `/api/v1/accounts/${accountId}/status-pages/${pageId}/components`, {
				json: params,
			}),
		) as Component;
	}
	...
	async listComponents(accountId: string, pageId: string): Promise<Component[]> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/components`),
		) as Component[];
	}
	...
	async updateComponent(
		...
		return JSON.parse(
			await this.client.request("PUT", `/api/v1/accounts/${accountId}/status-pages/${pageId}/components/${compId}`, {
				json: params,
			}),
		) as Component;
	}
	...
	async createIncident(accountId: string, pageId: string, params: CreateIncidentParams): Promise<Incident> {
		return JSON.parse(
			await this.client.request("POST", `/api/v1/accounts/${accountId}/status-pages/${pageId}/incidents`, {
				json: params,
			}),
		) as Incident;
	}
	...
	async listIncidents(accountId: string, pageId: string): Promise<Incident[]> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/incidents`),
		) as Incident[];
	}

	async getIncident(accountId: string, pageId: string, incidentId: string): Promise<IncidentWithUpdates> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/incidents/${incidentId}`),
	...
	async updateIncident(
		...
		return JSON.parse(
			await this.client.request("PUT", `/api/v1/accounts/${accountId}/status-pages/${pageId}/incidents/${incidentId}`, {
				json: params,
			}),
		) as Incident;
	}
	...
	async postIncidentUpdate(
		accountId: string,
		pageId: string,
		incidentId: string,
		params: PostIncidentUpdateParams,
	...
	async createMaintenance(accountId: string, pageId: string, params: CreateMaintenanceParams): Promise<Maintenance> {
		return JSON.parse(
			await this.client.request("POST", `/api/v1/accounts/${accountId}/status-pages/${pageId}/maintenances`, {
				json: params,
			}),
		) as Maintenance;
	}
	...
	async listMaintenances(accountId: string, pageId: string): Promise<Maintenance[]> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/maintenances`),
		) as Maintenance[];
	}

	async getMaintenance(accountId: string, pageId: string, maintId: string): Promise<MaintenanceWithUpdates> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/maintenances/${maintId}`),
		) as MaintenanceWithUpdates;
	}
	...
	async updateMaintenance(
		...
		return JSON.parse(
			await this.client.request("PUT", `/api/v1/accounts/${accountId}/status-pages/${pageId}/maintenances/${maintId}`, {
				json: params,
			}),
		) as Maintenance;
	}
	...
	async postMaintenanceUpdate(
		accountId: string,
		pageId: string,
		maintId: string,
		params: PostMaintenanceUpdateParams,
	...
	async listSubscribers(accountId: string, pageId: string): Promise<Subscriber[]> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/subscribers`),
		) as Subscriber[];
	}
	...
	async createIncidentTemplate(
		accountId: string,
		pageId: string,
		params: CreateIncidentTemplateParams,
	): Promise<IncidentTemplate> {
		return JSON.parse(
			await this.client.request("POST", `/api/v1/accounts/${accountId}/status-pages/${pageId}/incident-templates`, {
				json: params,
			}),
		) as IncidentTemplate;
	}
	...
	async listIncidentTemplates(accountId: string, pageId: string): Promise<IncidentTemplate[]> {
		return JSON.parse(
			await this.client.request("GET", `/api/v1/accounts/${accountId}/status-pages/${pageId}/incident-templates`),
		) as IncidentTemplate[];
	}
